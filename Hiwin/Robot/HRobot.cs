...
namespace SDKHrobot {
    ...
    public class HRobot {
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int set_pr( int robot, int pr_num, int pr_type, [In, Out] double[] coor, double[] ext_pos, int tool, int _base );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_pr( int robot, int pr_num, ref int pr_type, [In, Out] double[] coor, double[] ext_pos, ref int tool, ref int _base );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int base_calibration( int robot, int type, [In] double[] p0, [In] double[] p1, [In] double[] p2, [In, Out] double[] result );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int tool_calibration( int robot, int type, [In] double[] p0, [In] double[] p1, [In] double[] p2, [In] double[] p3, [In, Out] double[] result );
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int get_position_b0t0( int robot, [In, Out] double[] value );
        [DllImport( "HRSDK.dll" )]
        ...
        [DllImport( "HRSDK.dll" )]
        public static extern int get_hrss_sdkver( int robot, ref int large_ver, ref int small_ver, ref int revision);
        [DllImport( "HRSDK.dll" )]
        public static extern int get_hrsdk_sdkver( ref int large_ver, ref int small_ver, ref int revision);
        [DllImport( "HRSDK.dll" )]
        public static extern int get_robot_dh( int s, int type, double[,] dh_value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_gear_ratio( int s, double[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_robot_data( int robot, int[] sys_info, int[] port_info, double[,] axis_info );

        // IO all value
        [DllImport( "HRSDK.dll" )]
        public static extern int get_DI_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_DI_sim_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_DI_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_DO_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_DO_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_FI_all( int robot, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_FO_all( int robot, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_timer_status_all( int robot, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_timer_value_all( int robot, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_timer_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_counter_value_all( int robot, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_counter_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_fieldbus_rs_srw_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_fieldbus_rs_srr_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_fieldbus_rs_parameter_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_fieldbus_rs_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_system_input_all( int robot, int[] value, UInt16[] comment );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_system_output_all( int robot, int[] value, UInt16[] comment );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_MI_config_all( int robot, int[] sim, int[] value, int[] type, int[] start, int[] end );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_MI_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_MO_config_all( int robot, int[] value, int[] type, int[] start, int[] end );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_MO_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_PR_comment_array( int robot, int[] idx_array, int from_idx, int idx_len, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_SI_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_SI_sim_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_SO_range( int robot, int from_idx, int end_idx, int[] value );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_SI_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_SO_comment_range( int robot, int from_idx, int end_idx, UInt16[] comment, ref int next_idx );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_RI_all( int s, int[] values );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_RO_all( int s, int[] values );
        [DllImport( "HRSDK.dll" )]
        public static extern int get_VO_all( int s, int[] values );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_DI_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_DI_sim_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_DO_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_timer_value_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_counter_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_fieldbus_srw_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_SI_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_SI_sim_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_SO_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_MO_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_VO_array( int s, int[] indexes, int[] values, int len );
        [DllImport( "HRSDK.dll" )]
        public static extern int set_RO_array( int s, int[] indexes, int[] values, int len );
    }
